<section class="hero">
    <div class="container">
      ...
      <div class="hero-content pb-5 text-center">
        <h1 class="hero-heading">Marque (id:<?= $viewData['idBrand'] ?>)</h1>
        <div class="row">
      ...
      <div class="row">
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="py-2">
            ...
            <h3 class="h6 text-uppercase mb-1"><a href="<?= $absoluteURL ?>/catalogue/produit/1" class="text-dark">Kissing</a></h3><span class="text-muted">40€</span>
          </div>
        </div>
        <!-- /product-->
        <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              ...
              <h3 class="h6 text-uppercase mb-1"><a href="<?= $absoluteURL ?>/catalogue/produit/1" class="text-dark">Pink lady</a></h3><span class="text-muted">20€</span>
            </div>
          </div>
          <!-- /product-->
          <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1">Chausson</p>
              <h3 class="h6 text-uppercase mb-1"><a href="<?= $absoluteURL ?>/catalogue/produit/1" class="text-dark">Panda</a></h3><span class="text-muted">50€</span>
            </div>
          </div>
          <!-- /product-->
          <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              ...
              <h3 class="h6 text-uppercase mb-1"><a href="<?= $absoluteURL ?>/catalogue/produit/1" class="text-dark">Deadpool</a></h3><span class="text-muted">15€</span>
            </div>
          </div>
          <!-- /product-->
      </div>
